...
# pillow 
wget -P feeds/packages/lang/python/python-pillow https://raw.githubusercontent.com/woshisbsbsbsb/packages/openwrt-21.02/lang/python/pillow/Makefile
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=8.2.0/g' feeds/packages/lang/python/python-pillow/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=a787ab10d7bb5494e5f76536ac460741788f1fbce851068d73a87ca7c35fc3e1/g' feeds/packages/lang/python/python-pillow/Makefile
